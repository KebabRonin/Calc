...
void Display()
{
    float proj[16] = { 2 / 20,  0, 0, 0, 0, 2 / 20, 0, 0,  0, 0, 2/40, 0, 0, 0, 0, 1 };
  switch(prevKey) 
  {
  case '0':
  ...
  case '1':
      ...
      glTranslated(0, 0, -lat);
      glTranslated(lat / 2.0, lat / 2.0, lat / 2.0);
      glRotated(90, 1, 0, 0);                       //Aici am schimbat
      glTranslated(-lat / 2.0, -lat / 2.0, -lat / 2.0);
      DisplayAxe();
      DisplayObiect();
      glPopMatrix();
  ...
  case '2':
      ...
      //glTranslated(-lat, 0, -lat);
      glRotatef(15, 1, 0, 0);                       //Aici am schimbat
      glRotatef(-7, 0, 1, 0);                       //Aici am schimbat
      DisplayAxe();
      DisplayObiect();
      glPopMatrix();
      break;
